...
type Booking = { id: string; tutorId: string; status: string; subscription?: { status: string } | null };
...
export default function StudentDashboard() {
  ...
  const subscribedTutorIds = new Set(bookings.filter((booking) => booking.subscription?.status === "ACTIVE").map((booking) => booking.tutorId));
